...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 88, 579))
        ...
        self.appicon = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.appicon.setMinimumSize(QtCore.QSize(4, 0))
        self.appicon.setMaximumSize(QtCore.QSize(20, 20))
        self.appicon.setText("")
        self.appicon.setPixmap(QtGui.QPixmap(":/icons/icons/keyboard.png"))
        self.appicon.setScaledContents(True)
        self.appicon.setObjectName("appicon")
        self.horizontalLayout_2.addWidget(self.appicon)
        self.appname = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.appname.setObjectName("appname")
        self.horizontalLayout_2.addWidget(self.appname)
        self.verticalLayout_3.addLayout(self.horizontalLayout_2)
        self.addkeymap = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        self.addkeymap.setObjectName("addkeymap")
        self.verticalLayout_3.addWidget(self.addkeymap)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.appname.setText(_translate("MainWindow", "appname"))
        self.addkeymap.setText(_translate("MainWindow", "PushButton"))
